package com.hkm.consumerapp.ui.settings
...
import com.hkm.consumerapp.ui.settings.SettingsViewModel.Companion.KEY_LANGUAGE
import com.hkm.consumerapp.ui.settings.SettingsViewModel.Companion.KEY_REMINDER
        ...
        when (key) {
            ...
            KEY_REMINDER -> {
                ...
                if (switch)
                    ...
                    settingsViewModel.disableRemind(context as Context)
            }
        }
    }
}