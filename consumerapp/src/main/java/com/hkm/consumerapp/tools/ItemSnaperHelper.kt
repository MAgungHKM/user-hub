...
// Credit to Jag Saund: https://github.com/jsaund
// Source Code: https://github.com/jsaund/Playground/blob/master/app/src/main/java/com/experiments/jagsaund/playground/recyclerview/ItemSnapHelper.kt
// Applied and Modified as i see fit
class ItemSnaperHelper : LinearSnapHelper() {
    companion object {
        private const val MILLISECONDS_PER_INCH = 100f
        private const val MAX_SCROLL_ON_FLING_DURATION_MS = 500
    }
    ...
    override fun createScroller(layoutManager: RecyclerView.LayoutManager?): RecyclerView.SmoothScroller? {
        ...
        return object : LinearSmoothScroller(context) {
            override fun onTargetFound(
                ...
                val dt = calculateTimeForDeceleration(abs(dy))
                val time = min(1, max(MAX_SCROLL_ON_FLING_DURATION_MS, dt))
